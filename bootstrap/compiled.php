...
class Application extends Container implements HttpKernelInterface, TerminableInterface, ResponsePreparerInterface
{
    ...
    {
        return 'E:\\Program Files\\wamp\\www\\LaraShop\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation' . '/start.php';
    }
    ...
    public function handle($level, $message, $file = 'unknown', $line = 0, $context = array())
    {
        ...
        if ($this->displayErrors && error_reporting() & $level && $this->level & $level) {
            if (!class_exists('Symfony\\Component\\Debug\\Exception\\ContextErrorException')) {
                require 'E:\\Program Files\\wamp\\www\\LaraShop\\vendor\\symfony\\debug\\Symfony\\Component\\Debug' . '/Exception/ContextErrorException.php';
            }
            if (!class_exists('Symfony\\Component\\Debug\\Exception\\FlattenException')) {
                require 'E:\\Program Files\\wamp\\www\\LaraShop\\vendor\\symfony\\debug\\Symfony\\Component\\Debug' . '/Exception/FlattenException.php';
            }
            ...
            if (is_array($exceptionHandler) && $exceptionHandler[0] instanceof ExceptionHandler) {
                ...
                if (!class_exists('Symfony\\Component\\Debug\\Exception\\DummyException')) {
                    require 'E:\\Program Files\\wamp\\www\\LaraShop\\vendor\\symfony\\debug\\Symfony\\Component\\Debug' . '/Exception/DummyException.php';
                }
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = 'E:\\Program Files\\wamp\\www\\LaraShop\\vendor\\filp\\whoops\\src\\Whoops\\Handler' . '/../Resources';
        }
